...
export const metadata: Metadata = {
  title: "F1 Motors - Elite Racing Vehicles",
  description: "Discover premium Formula 1 racing cars with cutting-edge performance technology. Experience elite motorsport engineering at its finest.",
  keywords: "F1 cars, racing vehicles, motorsport, performance cars, luxury racing",
  ...
  openGraph: {
    title: "F1 Motors - Elite Racing Vehicles",
    description: "Premium Formula 1 racing cars with advanced performance technology",
    siteName: "F1 Motors",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1764609296718-rplpuj6k.jpg",
  ...
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1764609296718-rplpuj6k.jpg"]
  },
  robots: {
    index: true,
    follow: true
